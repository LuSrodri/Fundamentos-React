...
<p><strong>To run</strong> is need to clone this project with <strong>git clone</strong> and in the root run <strong>npm install</strong> and <strong>npm start</strong> in terminal.</p>
